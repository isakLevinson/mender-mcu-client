        ...
        if (xQueueReceive(keep_alive_storage->q, (void *) &client_action,
            ...
            switch (client_action.type) {
                ...
                case STOP_TASK:
                    ...
                    break;
                default:
                    ERROR("Unexpected client action");
                    break;
            }
        } else {
